                ...
                <div className="d-flex justify-content-between align-items-start levels my-3 " >
                    <div className="me-2 position-relative " >
                        ...
                        <div className="p-1 mt-1" >
                            <h6 className="fw-bold " >Measurement</h6>
                            <p className="text-secondary  " >Collecting and analyzing data for customer-experience-related outcomes</p>
                        </div>
                    ...
                    <div className=" mx-2 position-relative" >
                        ...
                        <div className="p-1 mt-2" >
                            <h6 className="fw-bold " >Governance and Strategy</h6>
                            <p className="text-secondary  " >Institutionalizing CX by holding agency leaders accountable, defining processes and aligning business initiatives </p>
                        </div>
                    ...
                    <div className="mx-2 position-relative " >
                        ...
                        />
                        <div className="p-1 mt-2" >
                            <h6 className="fw-bold " >Culture and Organization</h6>
                            <p className="text-secondary  " >Hiring CX experts and supporting human-centered design (HCD) tools and processes</p>
                        </div>
                    ...
                    <div className=" mx-2  position-relative" >
                        ...
                        />
                        <div className="p-1 mt-2" >
                            <h6 className="fw-bold " >Customer Understanding</h6>
                            <p className="text-secondary  " >Collecting qualitative and quantitative data about customer needs and customer journeys </p>
                        </div>
                    </div>
                    ...
                    <div className=" ms-2  position-relative" >
                        ...
                        />
                        <div className="p-1 mt-2" >
                            <h6 className="fw-bold " >Service Design and Improvement</h6>
                            <p className="text-secondary  " >Fixing broken services and introducing new ones, always with customers and their needs at the center of development </p>
                        </div>
                    </div>
                </div>
                <Link to="/questions">
